...
var flipCounter = function (d, options) {
    ...
    var isEqual = (options.value == options.maxValue);
    ...
    function _drawCounter() {
        ...
        var liHeight =counter['heightAndWidth']['liHeight']+'px';
        var halfHeight =counter['heightAndWidth']['halfHeight']+'px';
        var liWidth =counter['heightAndWidth']['liWidth']+'px';
        var color = counter['color'];
        var textShadow = counter['textShadow'];
        ...
        if (counter.decimals) {
            for (i = 0; i < counter.decimals; i++) {
                ...
                html += '<li class="digit" style="width: '+liWidth+';height:'+liHeight+';font-size: '+liWidth+';text-shadow: '+textShadow+'" id="' + d + '-digit-a' + i + '">' +
                    '<div class="line" style="width: '+liWidth+';height:'+halfHeight+';font-size: '+liWidth+'" ></div>' +
                    '<span class="front" style="width: '+liWidth+'; height:'+halfHeight+';font-size: '+liWidth+';padding-top: '+halfHeight+';color: '+color+'">' + dNew + '</span>' +
                    '<span class="back" style="width: '+liWidth+';height:'+halfHeight+';font-size: '+liWidth+';color: '+color+'">' + dOld + '</span>' +
                    '<div class="hinge-wrap"><div class="hinge" style="width: '+liWidth+';height:'+halfHeight+';font-size: '+liWidth+'">' +
                    '<span class="front" style="width: '+liWidth+';height:'+halfHeight+';font-size: '+liWidth+';padding-top: '+halfHeight+';color: '+color+'">' + dOld + '</span>' +
                    '<span class="back" style="width: '+liWidth+';height:'+halfHeight+';font-size: '+liWidth+';color: '+color+'">' + dNew + '</span>' +
                    '</div></div>' +
                    '</li>';
            }
            // html += '<li class="digit-delimiter" style="font-size: '+liWidth+'">.</li>'
        }

        //兼容 ie9
        var display =isEqual?"none":"block";
        ...
        for (i; i < digitsAnimate.length; i++) {
            ...
            html += '<li class="digit" style="width: '+liWidth+';height:'+liHeight+';font-size: '+liWidth+';text-shadow: '+textShadow+'" id="' + d + '-digit-a' + i + '">' +
                ...
                '<span class="front" style="width: '+liWidth+';height:'+halfHeight+';font-size: '+liWidth+';padding-top: '+halfHeight+';color: '+color+'">' + dNew + '</span>' +
                '<span class="back" style="width: '+liWidth+';height:'+halfHeight+';font-size: '+liWidth+';color: '+color+'">' + dOld + '</span>' +
                '<div class="hinge-wrap" style="display:'+display+'"><div class="hinge" style="width: '+liWidth+';height:'+halfHeight+';font-size: '+liWidth+'">' +
                '<span class="front" style="width: '+liWidth+';height:'+halfHeight+';font-size: '+liWidth+';padding-top: '+halfHeight+';color: '+color+'">' + dOld + '</span>' +
                '<span class="back" style="width: '+liWidth+';height:'+halfHeight+';font-size: '+liWidth+';color: '+color+'" >' + dNew + '</span>' +
                '</div></div>' +
                '</li>';
