let warning_anjianSmall =  {
    ...
    template:`<div class="anjianBig-judge-center judge-center">
                    <div class="judge-center-header">
                        <div class="judge-center-title"><span class="title-name blueShadow-big-title">高发案件小类预警</span><span class="title-btn" @click="tlvalueClick"><i class="xb_icon info-circle"></i></span></div>
...
<div class="anjian-main-3-list-box shehuixiaolei-shijian">
...
<div class="listLine"></div>
<div class="anjian-main-3-list-box shehuixiaolei-bujian">

</div>
                    
                    </div>
</div>              <div class="LineMapTitle">近30天高发案件小类预警走势<div class="anjian-btn-box"><div class="anjian-btn-left" @click="shehuiXleiClick(0)" :class="{'anjianAc':curId_1==0}">总体</div><div class="anjian-btn-min" @click="shehuiXleiClick(1)" :class="{'anjianAc':curId_1==1}">事件</div><div class="anjian-btn-right" @click="shehuiXleiClick(2)" :class="{'anjianAc':curId_1==2}">部件</div></div></div>
                    <div id="anjianSmallLin"></div>        
    ...
    mounted:function(){
        //下钻弹窗
        $('.judge-center').off('click').on('click','.shehui-xiaoleiPop',function(){
            var type  = $(this).data('type');
            var code  = $(this).data('id');
            warningPop.detail(type,code)
        })
        this.shehuiXleiLin = new cacheData();
        this.shehuiXleiLin.setRule({
    ...
    <div class="shehui-xiaoleiPop anjian-main-3-list-4" style="top: 14px" 
    ...
    <img src="/dsj_wjjkq_web/public/biz/index/image/home_btn_icon_deep.svg" width="100%"></span></div>
                ...
                $('.shehuixiaolei-shijian').html(tpl)
            }
    ...
    <div class="anjian-main-3-list-3">${data.list[i].totalNum}</div>
    <div class="shehui-xiaoleiPop anjian-main-3-list-4" style="top: 14px"
     data-id="${data.list[i].id}" data-type="${data.list[i].type}"><span class="anjian-card-full-btn card-full-btn">
     <img src="/dsj_wjjkq_web/public/biz/index/image/home_btn_icon_deep.svg" width="100%"></span></div>
</div>`
                }
                $('.shehuixiaolei-anjianjian').html(tpl)
            }

        });
        this.shehuiXleiClick(0)
        },
    ...
    methods: {
        ...
        tlvalueClick(){
            var p = pop.view({
                ...
                content: '',
                success: function () {
                    quzhiDetail.init(p.$ow_open_cont,4)
                }
            })
        },
        shehuiXleiClick(i){
            let that = this;
            that.curId_1 = i;
            this.shehuiXleiLin.getData(i,function(data){
    ...
    <div class="shehui-shijianPop anjian-main-3-list-4" style="top: 14px" 
    data-time="${obj.time}"" data-id="${obj.id}" data-type="${obj.type}">
    <span class="anjian-card-full-btn card-full-btn">
    <img src="/dsj_wjjkq_web/public/biz/index/image/home_btn_icon_deep.svg" width="100%"></span></div>
</div>`
            }
    ...
    <div class="anjian-main-3-list-3">${obj.totalNum}</div>
    <div class="shehui-shijianPop anjian-main-3-list-4" style="top: 14px"
     data-id="${obj.id}" data-type="${obj.type}">
     <span class="anjian-card-full-btn card-full-btn">
     <img src="/dsj_wjjkq_web/public/biz/index/image/home_btn_icon_deep.svg" width="100%"></span></div>
</div>`
            }
