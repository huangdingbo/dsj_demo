...
//预警数
        ...
        ajax_jsonp_request({
            ...
            fn:function(data){
                jichuGrid.draw(_this.mapObj,data.baseGirdList);
                warningMarker.draw(_this.mapObj,data.baseGirdList,2)
            }
        });
    ...
    methods: {
        ...
        quezhi:function () {
            var p = pop.view({
                ...
                content: '',
                success: function () {
                    quzhiDetail.init(p.$ow_open_cont,2)
                }
            })
        },
