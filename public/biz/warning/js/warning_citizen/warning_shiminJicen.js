...
let warning_shiminJicen =  {
    ...
    template:`<div class="judge-center">
                    <div class="judge-center-header">
                        <div class="judge-center-title"><span class="title-name blueShadow-big-title">高发基层网格预警</span>
                            ...
                            <div class=" society_tab">
                             ...
                             <div class="society_chart">
                                <div class="society_chart_left">
                                    <div class="society_title">基层预警统计</div>
                                    <div class="society_cont">
                                       <div class="society_content font-blue font-weight">
                                            <div class="society_content_item">网格名称</div>
                                ...
                                <div class="society_chart_right">
                                    <div class="society_title">基层网格预警近30天走势</div>
...
//预警数
        ...
        ajax_jsonp_request({
            ...
            fn:function(data){
                jichuGrid.draw(_this.mapObj,data.baseGirdList,{type:0,isGridView:true});
                warningMarker.draw(_this.mapObj,data.baseGirdList,7)
    ...
    methods: {
        ...
        yuzhi:function () {
            var p = pop.view({
                ...
                content: '',
                success: function () {
                    quzhiDetail.init(p.$ow_open_cont,7)
                }
            })
        },
    }
